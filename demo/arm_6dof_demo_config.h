...
enum ARM_6DOF_SERVO_IdType {ACT_BASE, ACT_L1, ACT_L2, ARM_6DOF_SERVO_CHANNEL_NR_OF};
enum ARM_6DOF_SEGMENT_IdType {SEG_BASE, SEG_L1, SEG_L2, ACT_ROLL, ACT_PITCH, ACT_CLAW, ARM_6DOF_SEGMENT_CHANNEL_NR_OF};
